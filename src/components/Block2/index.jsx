...
const Block2 = () => {
  ...
  return (
    <section id="skills-section" className="w-full bg-[#11071F] py-20">
      <div className="max-w-[1200px] mx-auto px-6 flex flex-col items-start gap-10">
        <div id='skills' className='py-20'>
        <h1 className="text-5xl font-extrabold tracking-wide text-[#7127BA] text-left scroll-smooth">
								Навыки
        </h1>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
          {skills.map((skill, index) => (
            <div
              key={index}
              className={`flex flex-col items-center p-6 rounded-2xl shadow-lg transition-all duration-300 transform bg-gradient-to-br from-[#2A0944] to-[#7127BA] text-white hover:scale-105 hover:translate-y-2 hover:shadow-2xl`}
            >
